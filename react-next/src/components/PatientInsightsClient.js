      ...
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-5 md:px-8 py-4 flex items-center gap-3">
          ...
          <div className="text-sm text-slate-400">
            ...
            <span className="text-slate-700 font-medium">Insights de IA</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-5 md:px-8 py-8 md:py-12">
        ...
        {exams.length === 0 ? (
          <div className="border border-slate-200 rounded-2xl p-10 text-center">
            ...
            <p className="text-sm text-slate-400 mb-5">A IA precisa de pelo menos um exame para gerar insights.</p>
          ...
          <>
            ...
            {insights === null && !loading && (
              <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-8 md:p-10 text-center mb-8">
                ...
                <div className="relative">
                  ...
                  <h2 className="text-xl md:text-2xl font-bold text-slate-800 mb-2">Análise inteligente do histórico</h2>
                  <p className="text-sm text-slate-500 max-w-md mx-auto mb-6">
                    A IA cruza os {exams.length} exame{exams.length !== 1 ? 's' : ''} deste paciente para identificar
            ...
            {loading && (
              <div className="rounded-3xl border border-slate-200 p-12 text-center mb-8">
                ...
                <p className="text-sm font-medium text-slate-600">Analisando o histórico com IA…</p>
            ...
            {insights && !loading && (
              <div className="mb-8">
                ...
                {insights.length === 0 ? (
                  <p className="text-sm text-slate-400">Nenhum insight relevante identificado.</p>
                ) : (
                ...
                <div className="flex items-center justify-center gap-1.5 mt-6">
                  ...
                  <span className="text-[11px] text-slate-400 font-medium">Análise gerada por Claude Sonnet 4.6</span>
                </div>
              </div>
            )}
